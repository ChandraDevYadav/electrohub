...
const Carousel = () => {
    ...
    return (
        ...
        >
            <div className="relative flex items-center w-full bg-[#e6e1e1] rounded-lg ">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 md:gap-16 shadow-lg rounded-lg overflow-hidden px-4 md:px-36 py-0 md:py-20">
                    {/* Image */}
                    ...
                    <div className="col-span-3 p-4 md:text-left">
                        ...
                        <div>
                            <p className="text-md md:text-2xl font-semibold text-black">
                                {items[currentIndex].description}
                            </p>
                            <p className="text-xl md:text-2xl font-semibold text-red-600 mt-8">
                                {items[currentIndex].name}
                            </p>
                            <h2 className="text-md md:text-lg mb-2 md:mb-4 text-black">
