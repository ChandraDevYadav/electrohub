...
const WhyUs = () => {
  return (
    <div className="bg-[#ffffff] px-4 md:px-36 py-10 md:py-16">
      <div className='flex justify-center items-center'>
        <div>
          ...
          <p className='text-4xl font-bold text-center text-black mt-4 '>Gadget Repair For Everyone</p>
          <p className='text-black text-center text-lg md:text-lg font-medium mt-5 mb-10'>Duis aute irure dolor in repreh enderit in volup tate velit esse cillum dolore <br />
      ...
      <div className='flex justify-center items-center text-center py-10 text-black text-lg'>
