    ...
    <div className="relative">
      ...
      <div className='bg-cover bg-center py-16 md:py-24 relative' style={{backgroundImage: "url('/main-slider-1-3.jpg')"}}>
        ...
        <div className="flex justify-center items-center relative z-10">
          <div>
            <div className="flex justify-center items-center gap-4 pt-0 md:pt-6">
              <div className="w-12 h-[2px] bg-white"></div>
              <h1 className="text-lg md:text-xl text-white font-medium">CONTACT US</h1>
              <div className="w-12 h-[2px] bg-white"></div>
            </div>
            <p className='text-center text-3xl md:text-4xl my-5 mx-6 md:mx-0 font-bold text-white'>
              Get support for your problem
            </p>
            <p className='text-center text-white font-medium mx-2'>
              Duis aute irure dolor in repreh enderit in volup tate velit esse cillum dolore <br className='hidden md:block'/>
