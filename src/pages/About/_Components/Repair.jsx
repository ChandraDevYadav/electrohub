...
const Repair = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-5 gap-12 bg-[#f7f7f9] pt-8 md:pt-24 pb-12 md:pb-[5rem] px-4 md:px-36'>
            ...
            <div className='col-span-5 md:col-span-3'>
                <div className='ml-0 md:ml-10'>
                    ...
                    <p className='text-4xl font-semibold py-6'>We Can Fix It Almost As Fast <br className='hidden md:block'/> As You Can Break It.</p>
                    ...
                    <div className='flex justify-start items-center'>
                        <button className="relative bg-red-600 text-white mt-1 md:mt-6 font-bold px-12 py-4 rounded-md overflow-hidden group">
