...
const Experience = () => {
  return (
    <div className="bg-[#2e2e2e] bg-cover bg-left" style={{backgroundImage: "url('/experience-one-shape-1.jpg')"}}>
      ...
      <h1 className="text-center text-4xl md:text-5xl font-bold my-6 mx-2 px-2 md:px-0 text-white">
        We Have Than 20 Years Experience in Gadget <br className='hidden md:block'/> Smartphone & Laptop
        Repair Services
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 md:px-40 py-4 md:pt-20">
        <div className="flex justify-center items-center">
          <div className="relative flex justify-center items-center gap-8 px-2 py-3 bg-[#1a1a1b] rounded-md text-white overflow-hidden group">
            ...
            <div className="relative flex justify-center items-center gap-8 px-4 py-6">
              <img
                src="/cus-ser.png"
                className="w-20 bg-red-400 h-20 rounded-full p-2"
                alt=""
              />
